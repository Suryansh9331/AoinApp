...
//   const { iconColor, textColor: themeTextColor, backgroundColor: themeBackgroundColor } =
...
//         style={styles.sideBtn}
//       >
//         <Text style={[styles.arrow, { color: headerTextColor }]}>{label}</Text>
//       </Pressable>
//     );
//   };
...
//     const label = rightType === 'arrow-right' ? '›' : '≡';
...
//             <Text
//               numberOfLines={1}
//               style={[styles.subtitle, { color: headerTextColor }, subtitleStyle]}
//             >
//               {subtitle}
//             </Text>
//           )}
